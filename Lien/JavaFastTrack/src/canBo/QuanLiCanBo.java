...
public class QuanLiCanBo {
	...
	public static void main(String[] args) {
		...
		while(true) {
			System.out.println("-----Can Bo Management----");
			System.out.println("-------------------------------------------");
			System.out.println("1. Nhập thông tin danh sách cán bộ");
			...
			case 2: System.out.println("Bạn muốn xuất cán bộ nào: ");
					...
					break;
			case 3: int tongLuong = 0; 
					for(CanBo cb:dsCanBo) {
						tongLuong += cb.tinhLuong();
					}
					System.out.println("Tổng lương cán bộ là: "+tongLuong);
					break;
