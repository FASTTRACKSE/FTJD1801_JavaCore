...
public class SinhVienManagement {
	...
	public SinhVienManagement(String id, String name, String address, int age, double gpa) {
		super();
		this.id = id;
		this.name = name;
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			ArrayList<SinhVienManagement>listStudents = new ArrayList<SinhVienManagement>();
			switch(choice) {
				case 1: System.out.println("Nhập số lượng sinh viên cần nhập: ");
						int so = sc.nextInt();
						for(int i = 0; i < so; i++) {
							SinhVienManagement sinhvien = new SinhVienManagement();
							sinhvien.input();
				...
				case 2: System.out.println("Nhập ID cần cập nhật: ");
						...
						double gpa;
						int age;
						SinhVienManagement lst = new SinhVienManagement();
				...
				case 4: Collections.sort(listStudents, new Comparator<SinhVienManagement>() {
					public int compare(SinhVienManagement sv1, SinhVienManagement sv2) {
